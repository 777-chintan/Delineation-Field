...
Original file is located at
    https://colab.research.google.com/drive/1I684hZnP_3MI1x3Lm5Z0EM7XVqQmWkFL
...
#inpath_fields = Path(r'/home/shreekanthajith/intello_satellite/ForAfric-Agricultural-Fields-Delineation-masterdata/marker2016_small.shp')

#inpath_s2 = Path(r'/home/shreyans/Desktop/Agricultural-delineation/ForAfric-Agricultural-Fields-Delineation-master/data/Marker_2016_CVR_part_projected.tif')
#inpath_fields = Path(r'/home/shreyans/Desktop/Agricultural-delineation/ForAfric-Agricultural-Fields-Delineation-master/data/Marker_2016_CVR_part_projected.shp')

#inpath_s2 = Path(r'/home/shreyans/Desktop/Agricultural-delineation/ForAfric-Agricultural-Fields-Delineation-master/data/marker_2016_part_2_2/Marker_2016_CVR_part2_2.tif')
#inpath_fields = Path(r'/home/shreyans/Desktop/Agricultural-delineation/ForAfric-Agricultural-Fields-Delineation-master/data/marker_2016_part_2_2/Marker_2016_CVR_part2_2.shp')

inpath_s2 = Path(r'/home/chintu/Desktop/Delineation_field/ForAfric-Agricultural-Fields-Delineation-master/data/Minadanao_pineapple/Mindanao_pineapple_plantation_proj.tif')
inpath_fields = Path(r'/home/chintu/Desktop/Delineation_field/ForAfric-Agricultural-Fields-Delineation-master/data/Minadanao_pineapple/Mindanao_pineapple_plantation_proj.shp')
...
outpath_crs= outpath / 'crs.pkl'
chip_crs={}
if not outpath_crs.exists():
    with rasterio.open(inpath_s2) as src:
        raster_meta = src.meta
    crs=raster_meta['crs']
    chip_crs['crs']=crs 
    new_pickle(outpath_crs, chip_crs)
