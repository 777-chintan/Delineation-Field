...
#inpath_s2 = Path(r'data/Minadanao_pineapple/set2/Mindanao_set2_z18_proj.tif')
#inpath_fields = Path(r'data/Minadanao_pineapple/set2/Mindanao_set2_proj.shp')
inpath_s2 = Path(r'data/Minadanao_pineapple/17052021/Mindanao_17052021_proj.tif')
inpath_fields = Path(r'data/Minadanao_pineapple/17052021/Mindanao_17052021_proj.shp')
#inpath_s2 = Path(r'data/Minadanao_pineapple/set_2part1/Satellite_image_proj.tif')
#inpath_fields = Path(r'data/Minadanao_pineapple/set_2part1/Field_boundaries_proj.shp')
#inpath_s2 = Path(r'data/Minadanao_pineapple/Mindanao_pineapple_plantation_z18_proj.tif')
#inpath_fields = Path(r'data/Minadanao_pineapple/Mindanao_pineapple_plantation_proj.shp')
...
"""
img = rasterio.open(inpath_s2)
print(img.meta)
x,y = img.index(img.bounds.left,img.bounds.bottom+10)
print(x,y)
shapes= (gpd.read_file(inpath_fields, encoding='cp865')).filter(['AfgKode'])
print(shapes)
print(shapes.columns)
df = shapes[shapes.geometry.geom_type=='MultiPolygon']
#df.reset_index(drop=True, inplace=True)
#print(df.shape)
df = df.pipe(utils.geo.explode_mp)
for idx,row in df.iterrows():
    print(row.geometry.interiors)
"""
...
train_chip_dfs, val_chip_dfs = utils.coco.train_test_split(chip_dfs, test_size=0.17, seed=1)
